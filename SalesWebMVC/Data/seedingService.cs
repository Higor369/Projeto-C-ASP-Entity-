...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMVCContext context) //ao ser instanciada a classe, ele recebe uma dependencia do Context 
        {
            _context = context;
        }
        ...
        public void Seed() //popula base de dados caso ela nao esteja populada 
        {
            ...
            _context.SaveChanges(); //efetiva as alteraçoes no banco 
        }
    }
}
